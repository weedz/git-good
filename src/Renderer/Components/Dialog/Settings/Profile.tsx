        ...
        >
          <input
            ...
            onInput={(e) =>
              ...
              this.setConfigKey("profileName", e.currentTarget.value)
            }
          />
          <div class="pane">
            <h3>Auth type</h3>
              ...
              {this.state.config.authType === "ssh" && (
                <div>
                  ...
                  <div>
                    ...
                    {!this.state.config.sshAgent && (
                      <input type="text" disabled value={this.state.config.sshPublicKey} />
                    )}
                    <button
                  ...
                  <div>
                    ...
                    {!this.state.config.sshAgent && (
                      <input type="text" disabled value={this.state.config.sshPrivateKey} />
                    )}
                    <button
                      disabled={this.state.config.sshAgent}
                      id="ssh-private-key"
                  ...
                  <div>
                    ...
                    {!this.state.config.sshAgent && (
                      <input type="text" disabled value={this.state.config.sshPassphrase} />
                    )}
                    <input
                      disabled={this.state.config.sshAgent}
                      type="text"
              ...
              {this.state.config.authType === "userpass" && (
                <div>
                  {!this.state.showUserPass ? (
                    <button type="button" onClick={() => this.setState({ showUserPass: true })}>
