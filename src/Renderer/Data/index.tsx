...
export function discardChanges(filePath: string) {
  openNativeDialog(NativeDialog.DISCARD_CHANGES, { path: filePath });
}
export function discardAllChanges() {
  openNativeDialog(NativeDialog.DISCARD_ALL_CHANGES, null);
}
